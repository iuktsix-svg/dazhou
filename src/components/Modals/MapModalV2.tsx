...
const LOCATIONS: LocData[] = [
  ...
  { lat: 34.62, lng: 112.45, color: '#ff4444', size: 17, name: '洛阳', title: '京畿 · 洛阳城',
    ...
    chars: [
      ...
      { name: '藤原香子', title: '东瀛遣周使副使 · 东瀛才女', detail: '女 · 温婉端庄，常着繁复的十二单衣，举止合乎礼法。东瀛遣周使副使，常驻洛阳。无武功但才学渊博，擅长汉诗与茶道，是东瀛与大周文化交流的代表人物。' },
      { name: '玛利亚姆', title: '波斯星象与医毒学者', detail: '女 · 26岁。戴单片眼镜，精通星象占卜与医毒双术。波斯最博学的女性学者，常驻洛阳为大周贵族提供星象咨询与波斯医药。' },
    ],
