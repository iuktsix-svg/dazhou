...
const LOCATIONS: LocData[] = [
  ...
  { lat: 35.0, lng: 135.8, color: '#e88', size: 13, name: '京都', title: '东瀛 · 京都（平安京）',
    desc: '倭国都城，天皇御所。仿长安洛阳而建，遣唐使往来频繁。剑道、忍术、神道三脉并存。', chars: [
      ...
      { name: '藤原香子', title: '遣周使副使 · 东瀛才女', detail: '女 · 温婉端庄，常着繁复的十二单衣，举止合乎礼法。遣周使副使，无武功但才学渊博，擅长汉诗与茶道。' },
      { name: '德川宗严', title: '幕府老中 · 宗师境', detail: '男 · 秃顶老者，眼神阴鸷如鹫，常穿深色阵羽织。源氏幕府首席老中，实际政权的幕后掌控者。' },
    ], factionNote: '京都三极——天照神宫(千叶凛)·柳生剑派(柳生雪姬)·德川幕府(德川宗严)互不统属。藤原香子作为遣周使是大周与东瀛的外交桥梁。柳生雪姬与千叶凛暗中较劲——剑道vs神道。' },
  ...
  { lat: 35.7, lng: 51.4, color: '#e88', size: 14, name: '波斯', title: '波斯 · 萨珊流亡王庭',
    desc: '古波斯帝国后裔，萨珊王朝覆灭后流亡东方。拜火教圣火不灭，复国梦从未熄灭。', chars: [
      ...
      { name: '巴赫拉姆', title: '驻大周正使 · 50岁', detail: '男 · 波斯流亡政府驻大周正使。常年往返于洛阳与波斯之间，为大周与波斯的外交桥梁。' },
      { name: '萨拉', title: '拜火教大祭司 · 35岁', detail: '女 · 波斯拜火教总教大祭司。掌控圣火仪式，是波斯流亡者的精神领袖。与天山明教赫连城有教义上的隐秘联系。' },
    ], factionNote: '波斯流亡政府四柱——希林(王权象征)·阿尔达希尔(军事)·巴赫拉姆(外交)·萨拉(宗教)。明教与拜火教同源——赫连城与萨拉有隐秘的教义交流。' },
  { lat: 36.0, lng: 54.0, color: '#e88', size: 8, name: '波斯东境', title: '波斯 · 东境商路',
    desc: '丝绸之路波斯段，商队络绎不绝。', chars: [
      ...
      { name: '玛利亚姆', title: '星象与医毒学者 · 26岁', detail: '女 · 戴单片眼镜，精通星象占卜与医毒双术。波斯最博学的女性学者，常为大周贵族提供星象咨询。' },
    ], factionNote: '阿米娜的商会是丝路贸易的最大中间商。莱拉的情报网覆盖丝路全线。玛利亚姆的学问在大周贵族圈备受追捧。' },
  ...
  { lat: 50.8, lng: -1.1, color: '#e88', size: 8, name: '朴茨茅斯', title: '英吉利 · 朴茨茅斯（军港）',
    desc: '皇家海军母港，东印度公司总部。', chars: [
      { name: '夏洛特', title: '东印度商会驻大周总办 · 冲脉境', detail: '女 · 金发碧眼，常着大周丝绸改良的洋装。东印度商会驻大周总办，是英吉利与大周贸易的直接负责人。与广州万国商会金若水有深度贸易往来。' },
      { name: '爱丽丝', title: '军情暗部"夜莺"王牌特工 · 通明境', detail: '女 · 身形娇小，擅长变装与毒杀。军情暗部"夜莺"王牌特工，负责在东方收集军事与商业情报。' },
    ], factionNote: '夏洛特掌控英吉利与大周的贸易线。爱丽丝是伊丽莎白安插在东方的耳目。两人经常与广州金若水打交道。' },
  { lat: 51.7, lng: -0.2, color: '#e88', size: 7, name: '伦敦西郊', title: '英吉利 · 皇家医学院',
    desc: '西洋医学与慈善中心。', chars: [
      { name: '海伦', title: '驻大周修女兼医师 · 凡骨', detail: '女 · 亚麻色长发，常穿素白修女服。驻大周的英吉利修女兼医师，以西洋医术在大周行医。与高丽宋智恩有医术交流。' },
    ], factionNote: '海伦以医疗慈善为名在大周活动，是英吉利文化输出的柔和力量。' },
];
