...
const ROUTES: { path: [number, number][]; color: string; dash: string; weight: number; label: string; desc: string }[] = [
  ...
  { path: [[32.06,118.80],[32.5,122],[33.5,123],[34.5,123],[35.5,122.5],[36.5,122],[37.5,122.5],[37.80,120.75],[38.2,120],[38.8,119],[39.3,118.5],[39.91,118]], color: '#4a6a6a', dash: '5,7', weight: 1.2, label: '东部沿海航线',
    desc: '金陵→登州→幽州。沿海福船穿梭不息，离岸航行。登州港为北方最大出海港，幽州为海陆转运枢纽。巨蛟帮盘踞沿线岛屿。' },
  ...
  // ═══ 海上丝绸之路 ═══
  // 海上丝路 — 紧贴中南半岛海岸线
  { path: [[23.13,113.26],[22,112],[20.5,111],[19,110],[17,109],[14,109],[12,108],[10,107],[8,106],[6,105],[4,104],[2.2,102.2],[1,103],[0,104],[-1,104],[-2,104],[-3.0,104.7],[-4,106],[-5,107],[-6,109],[-7,111],[-7.5,112.5]], color: '#5a8a9a', dash: '6,8', weight: 2, label: '海上丝绸之路（南洋段）',
    desc: '广州→海南→占城→真腊→暹罗湾→马六甲→三佛齐→满者伯夷。紧贴中南半岛海岸线南下，南洋香料、象牙、珍珠从此线北上。金若水的万国商会与莎雅女王的香料帝国在此博弈。陈祖义与红姑盘踞马六甲。' },
  // 西洋航线 — 印度洋真实航线
  { path: [[23.13,113.26],[20,111],[15,109],[10,106],[5,105],[0,100],[-2,95],[-3,90],[0,85],[5,80],[10,76],[15,73],[18,68],[20,60],[22,52],[25,45],[28,40],[30,35],[32,32],[34,28],[36,25],[38,20],[40,15],[42,10],[44,5],[46,0],[48,-2],[50,-2],[51.5,-0.1]], color: '#7a9aba', dash: '6,10', weight: 1.5, label: '西洋航线（至英吉利）',
    desc: '广州→马六甲→锡兰→天竺南端→阿拉伯海→红海→地中海→英吉利。跨印度洋远洋航线。夏洛特的东印度公司正探索此线以绕开波斯与阿拉伯中间商。' },

  // ═══ 海外朝贡/遣使路线 ═══
  // 遣周使航线 — 东海真实航线，经朝鲜海峡和对马海峡
  { path: [[34.62,112.45],[32.06,118.80],[33,122],[34,123],[35,123],[36,123],[37,122.5],[36,124],[35,126],[34,128],[33,129.5],[33,131],[33.5,133],[34,134],[34.5,135.5],[35.0,135.8]], color: '#e89888', dash: '6,6', weight: 1.3, label: '遣周使航线（东瀛）',
    desc: '洛阳→金陵→登州→朝鲜海峡→对马海峡→京都。东瀛遣周使往返大周的官方海上航线，完全沿东海和对马海峡航道。季风时节顺风十日可达。' },
  // 高丽朝贡 — 陆路至登州，横渡黄海
  { path: [[34.62,112.45],[36,117],[37.5,119],[37.80,120.75],[37.5,122],[37,123.5],[37.5,125],[37.9,126.6]], color: '#c8a8e8', dash: '6,6', weight: 1.3, label: '高丽朝贡路线',
    desc: '洛阳→济南→登州→横渡黄海→开城。高丽每年遣使朝贡。李明月曾为大周质子往返此线，朴贞熙的东海商会控制沿线海上贸易。黄海最窄处仅二百里，一日可渡。' },
